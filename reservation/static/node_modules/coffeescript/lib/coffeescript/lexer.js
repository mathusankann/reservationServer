...
(function() {
  ...
  ({Rewriter, INVERSES} = require('coffeescript/lib/coffeescript/rewriter'));

  // Import the helpers we need.
  ({count, starts, compact, repeat, invertLiterate, merge, attachCommentsToNode, locationDataToString, throwSyntaxError} = require('coffeescript/lib/coffeescript/helpers'));
