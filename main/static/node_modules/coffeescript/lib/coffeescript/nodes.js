...
(function() {
  ...
  ({isUnassignable, JS_FORBIDDEN} = require('coffeescript/lib/coffeescript/lexer'));

  // Import the helpers we plan to use.
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError} = require('coffeescript/lib/coffeescript/helpers'));
