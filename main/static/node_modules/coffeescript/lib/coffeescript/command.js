...
(function() {
  ...
  helpers = require('coffeescript/lib/coffeescript/helpers');

  optparse = require('coffeescript/lib/coffeescript/optparse');
  ...
  exports.run = function() {
    ...
    if (opts.interactive) {
      return require('coffeescript/lib/coffeescript/repl').start(replCliOpts);
    }
    if (opts.stdio) {
      return compileStdio();
    }
